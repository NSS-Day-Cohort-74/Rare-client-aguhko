...
import { CreateAPost } from "../components/posts/form/CreateAPost";
...
import CommentOnPost from "../components/posts/form/CommentOnPost";
    ...
    <Routes>
      ...
      <Route element={<Authorized token={token} />}>
        ...
        <Route
          ...
          element={<CommentOnPost token={token} />}
        />
        <Route path="/users">
